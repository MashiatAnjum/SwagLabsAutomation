...
class standardUserActions {
    async enterUsername() {
        ...
        async firstName(){
            await standardUserObjects.enterfirstName.setValue("Mashiat");
             await browser.pause(3000);
        }
        async lastName(){
            await standardUserObjects.enterLastName.setValue("Anjum");
             await browser.pause(3000);
        }
        async zipCode(){
            await standardUserObjects.enterZipcode.setValue("1212");
             await browser.pause(3000);
        }
